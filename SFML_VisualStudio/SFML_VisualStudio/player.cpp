...
CPlayer::CPlayer()
{
   strncpy_s(m_pcName, "Default", g_kiMaxChars - 1);
   strncpy_s(m_pcClassName, "Default", g_kiMaxChars - 1);
   m_iAccuracy = 0;
   m_iHitPoints = 0;
   m_iMaxHitPoints = 0;
   m_iExpPoints = 0;
...
void
CPlayer::TakeDamage(int _iDamage)
{
...
CPlayer::CreateClass()
{
   ...
   scanf_s("%s", m_pcName, g_kiMaxChars);
   ...
   {
   case 1:  // Fighter
      strncpy_s(m_pcClassName, "Fighter", g_kiMaxChars - 1);
      m_iAccuracy = 13;
      m_iHitPoints = 22;
      m_iMaxHitPoints = 25;
      m_iExpPoints = 0;
      ...
      m_iLevel = 1;
      m_iArmor = 4;
      strncpy_s(m_Weapon.pcName, "Long Sword", g_kiMaxChars - 1);
      m_Weapon.DamageRange.iLow = 1;
      m_Weapon.DamageRange.iHigh = 8;
      break;

   case 2:  // Wizard
      strncpy_s(m_pcClassName, "Wizard", g_kiMaxChars - 1);
      m_iAccuracy = 5;
      m_iHitPoints = 10;
      m_iMaxHitPoints = 10;
      m_iExpPoints = 0;
      ...
      m_iLevel = 1;
      m_iArmor = 1;
      strncpy_s(m_Weapon.pcName, "Staff", g_kiMaxChars - 1);
      m_Weapon.DamageRange.iLow = 1;
      m_Weapon.DamageRange.iHigh = 4;
      break;

   case 3:  // Cleric
      strncpy_s(m_pcClassName, "Cleric", g_kiMaxChars - 1);
      m_iAccuracy = 8;
      m_iHitPoints = 15;
      m_iMaxHitPoints = 15;
      m_iExpPoints = 0;
      ...
      m_iLevel = 1;
      m_iArmor = 3;
      strncpy_s(m_Weapon.pcName, "Flail", g_kiMaxChars - 1);
      m_Weapon.DamageRange.iLow = 1;
      m_Weapon.DamageRange.iHigh = 6;
      break;

   default: // Thief
      strncpy_s(m_pcClassName, "Thief", g_kiMaxChars - 1);
      m_iAccuracy = 7;
      m_iHitPoints = 12;
      m_iMaxHitPoints = 12;
      m_iExpPoints = 0;
      ...
      m_iLevel = 1;
      m_iArmor = 2;
      strncpy_s(m_Weapon.pcName, "Short Sword", g_kiMaxChars - 1);
      m_Weapon.DamageRange.iLow = 1;
      m_Weapon.DamageRange.iHigh = 6;
      break;
   }
...
bool
CPlayer::Attack(CMonster& _rMonster)
{
   // Combat is turn based: display an options menu.  You can,
